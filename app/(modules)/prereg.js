      ...
      <View className="flex-1 flex-col justify-center items-center"> 
        ...
        <View className="bg-white w-full h-[85%] rounded-t-[30px] absolute bottom-0 p-5 pt-20">
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {/* Header */}
            <View className="mb-5">
              <Text className="font-montserrat-bold text-lg text-center text-[#2d5016] mb-4">
                2ND SEMESTER 2025-2026 (PREREGISTRATION)
              </Text>
              
              <View className="flex-row bg-gray-100 p-3 rounded-md mb-4">
                <Text className="font-montserrat-bold text-red-600 text-xs">Note: </Text>
                <Text className="font-montserrat flex-1 text-xs text-gray-800">
                  Please be advised that the preregistration period is not your official registration. 
                  The preregistration will be used in slot monitoring.
                </Text>
              </View>

              <View className="bg-orange-500 p-3 rounded-md items-center">
                <Text className="font-montserrat-bold text-white text-sm">PREREGISTRATION IS NOW CLOSED</Text>
              </View>
            </View>
